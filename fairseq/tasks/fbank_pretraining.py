...
@dataclass
class FBankPretrainingConfig(FairseqDataclass):
...
@register_task("fbank_pretraining", dataclass=FBankPretrainingConfig)
class FBankPretrainingTask(FairseqTask):
    """ """

    cfg: FBankPretrainingConfig
    ...
    @classmethod
    def setup_task(cls, cfg: FBankPretrainingConfig, **kwargs):
        """Setup the task (e.g., load dictionaries).

        Args:
            cfg (FBankPretrainingConfig): configuration of this task
        """
    ...
    def load_dataset(self, split: str, epoch: int=1, task_cfg: FairseqDataclass = None, **kwargs):
