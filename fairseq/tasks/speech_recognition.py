...
@dataclass
class SpeechRecognitionConfig(FairseqConfig):
...
@register_task("speech_recognition", dataclass=SpeechRecognitionConfig)
class SpeechRecognitionTask(FairseqTask):
    ...
    @classmethod
    def setup_task(cls, cfg: SpeechRecognitionConfig, **kwargs):
    ...
    def build_model(self, model_cfg, from_checkpoint=False):
        ...
        return super(SpeechRecognitionTask, self).build_model(model_cfg, from_checkpoint)
